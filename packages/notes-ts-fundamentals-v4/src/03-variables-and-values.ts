...
let date4 = 'oops' as any as Date // to avoid the direct unresonable conversion addding any in between
...
const p = new Promise(result) // promise take callback function
